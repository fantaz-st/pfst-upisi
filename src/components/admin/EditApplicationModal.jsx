...
export default function EditApplicationModal({ open, onClose, application, intakeSlug }) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle sx={{ fontFamily: '"Source Serif 4", serif', fontWeight: 700 }}>
        Uređivanje prijave
      </DialogTitle>
      <DialogContent>
        {error && (
        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid size={{ xs: 12, sm: 6 }}>
            <FormControl fullWidth size="small">
              ...
              >
                {studyPrograms[intakeSlug]?.map((prog) => (
          ...
          <Grid size={{ xs: 12, sm: 8 }}>
            <TextField
              ...
              onChange={(e) => handleChange("previous_program", e.target.value)}
              fullWidth
              size="small"
            />
          </Grid>
