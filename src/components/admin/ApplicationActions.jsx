...
export default function ApplicationActions({ application, intakeSlug }) {
  ...
  return (
    <>
      ...
      <EditApplicationModal open={editOpen} onClose={() => setEditOpen(false)} application={application} intakeSlug={intakeSlug} />
